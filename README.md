...
this script is a combined and modified version from original autosub made by Anastasis Germanidis https://github.com/agermanidis/autosub and srt_translate made by 
jaredyam https://gist.github.com/jaredyam/4fe7527ccf6981595a879c9705e56c51
...
this script needs ffmpeg (ffmpeg.exe in Windows), so in linux you have to install it first and make sure it can be reached from any folder by adding its location folder into PATH ENVIRONTMENT

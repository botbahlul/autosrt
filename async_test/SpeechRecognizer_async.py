...
async def main():
    ...
    recognizer = SpeechRecognizer(language=src, rate=48000, api_key="AIzaSyBOti4mM-6x9WDnZIjIeyEU21OpBXqWBgw", error_messages_callback=show_error_messages)
    ...
    print("timed_subtitles = {}".format(timed_subtitles))

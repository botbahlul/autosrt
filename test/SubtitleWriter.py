...
timed_subtitles = writer.get_timed_subtitles()
print(timed_subtitles)
writer.write(subtitle_filepath)
print("Subtitle file created at : {}".format(subtitle_filepath))
